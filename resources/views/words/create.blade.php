        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('words.store') }}">
                ...
                <div>
                    ...
                    <x-jet-input id="word" class="block mt-1 w-full" type="text" name="name" :value="old('name')"
                    ...
                    <x-select name="grammar_class_id" id="grammar_class_id" class="w-full">
                        ...
                        @foreach($grammarClasses as $class)
                            <option value="{{ $class->id }}"
                                    @if(old('grammar_class_id') == $class->id) selected @endif>
                ...
                <div class="mt-4">
                    ...
                    <div class="max-w-xl flex flex-row flex-wrap justify-between pl-6">
                        @foreach($categories as $category)
                            <span class="mr-4">
                            <x-jet-input type="checkbox" name="categories[]" value="{{ $category->id }}"></x-jet-input>
